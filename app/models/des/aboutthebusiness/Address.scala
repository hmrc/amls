      ...
      case x: RegisteredOfficeUK    =>
        removeAmpersands(
          Address(
            ...
            x.addressLine4,
            "GB",
            convertEmptyOrInvalidToNone(x.postCode),
            x.dateOfChange
          )
        )
      case y: RegisteredOfficeNonUK =>
        removeAmpersands(
          Address(y.addressLine1, y.addressLine2, y.addressLine3, y.addressLine4, y.country, None, y.dateOfChange)
        )
    }
