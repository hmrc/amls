...
trait DateOfChangeUpdateHelper {
  ...
  def updateWithHvdDateOfChangeFlag(
    desRequest: AmendVariationRequest,
    viewResponse: SubscriptionView
  ): AmendVariationRequest = {
    val hvdWithDateOfChangeFlag = desRequest.hvd.fold(false)(
      !_.dateOfTheFirst.equals(viewResponse.hvd.fold[Option[String]](None)(_.dateOfTheFirst))
    )
  ...
  def updateWithSupervisorDateOfChangeFlag(
    desRequest: AmendVariationRequest,
    viewResponse: SubscriptionView
  ): AmendVariationRequest = {
  ...
  def updateWithBusinessActivitiesDateOfChangeFlag(
    desRequest: AmendVariationRequest,
    viewResponse: SubscriptionView
  ): AmendVariationRequest = {
    val businessActivitiesCommenceDateChangeFlag = desRequest.businessActivities.all.fold(false) {
      !_.activitiesCommenceDate.equals(
        viewResponse.businessActivities.all.fold[Option[String]](None)(_.activitiesCommenceDate)
      )
    }
