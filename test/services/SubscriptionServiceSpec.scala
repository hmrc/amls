    ...
    "return a successful response" which {
      "connects to EnrolmentStore" which {
        ...
        "returns duplicate response with amlsregno and there are stored fees" in new TestFixture {
          ...
          } thenReturn Future.successful(Some(Fees(SubscriptionResponseType, amlsRegistrationNumber, 500, Some(50), 115, 1000, Some("PaymentRef"), None, Some(100), Some(100.0), Some(100.0), new DateTime())))
