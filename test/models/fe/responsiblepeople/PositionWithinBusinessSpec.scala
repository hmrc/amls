...
class PositionWithinBusinessSpec extends PlaySpec with MockitoSugar {
  ...
  "JSON validation" must {
    ...
    "convert des model to frontend model successfully" in {
      ...
      val desModel = ResponsiblePersons(None,None,None,None,None,None,None,None,None,position,None,false,None,false,None,Some(today.toString()),false,None,extra = RPExtra())
    ...
    "convert des model to frontend model successfully with other details" in {
      ...
      positions.zip(expectedResults) foreach {
        case (pos, result) =>
          ...
          val desModel = ResponsiblePersons(None,None,None,None,None,None,None,None,None,Some(pos),None,false,None,false,None,Some(today.toString()),false,None,extra = RPExtra())
    ...
    "convert des model to frontend model successfully when user has no data selected" in {
      ...
      val desModel = ResponsiblePersons(None,None,None,None,None,None,None,None,None,position,None,false,None,false,None,None,false,None,extra = RPExtra())
