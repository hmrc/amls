...
object DefaultDesValues {
  ...
  private val desallActivitiesModel = Some(BusinessActivitiesAll(Some("1990-02-24"), activityDetails, franchiseDetails, noOfEmployees, noOfEmployeesForMlr,
  ...
  val hvdSection = Some(DesHvd(true,Some("1978-02-15"),true,Some(40),Some(HvdFromUnseenCustDetails(true,Some(ReceiptMethods(true,true,true,Some("foo")))))))
