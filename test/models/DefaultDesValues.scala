...
object DefaultDesValues {
  ...
  val BusinessCustomerDetails    = BusinessDetails(SoleProprietor, None, None)
  private val deseabServiceModel = Some(
    des.businessactivities.EabServices(
      false,
      false,
      true,
      false,
  ...
  private val deseabServiceModelLA = Some(
    des.businessactivities.EabServices(false, false, true, false, true, false, false, false, false, Some(true))
  )
  ...
  private val auditableRecordsDetails       =
  ...
  private val advisorNameAddress            = AdvisorNameAddress(
    "Name",
    Some("TradingName"),
    ATBAddress("Line1", Some("Line2"), Some("Line3"), Some("Line4"), "GB", Some("AA1 1AA"))
  )
  private val mlrAdvisor                    = Some(MlrAdvisor(true, Some(MlrAdvisorDetails(Some(advisorNameAddress), true, None))))
  private val desallActivitiesModel         = Some(
  ...
  private val servicesforRegOff             = Some(
    ServicesforRegOff(true, false, false, false, false, false, false, true, Some("other service"))
  )
  ...
  private val mlrActivitiesAppliedFor       = Some(
    MlrActivitiesAppliedFor(true, true, true, false, false, false, false, false)
  )
  private val msbServicesCarriedOut         = Some(MsbServicesCarriedOut(true, true, false, true, false))
  private val hvdGoodsSold                  = Some(
    HvdGoodsSold(
      true,
      true,
      true,
  ...
  val BusinessActivitiesSection = DesBusinessActivities(
    ...
    deseabServiceModel,
    ampServices,
    desallActivitiesModel
  )

  val BusinessActivitiesSectionLA = DesBusinessActivities(
    mlrActivitiesAppliedFor,
    msbServicesCarriedOut,
    hvdGoodsSold,
    hvdAlcoholTobacco,
  ...
  val AboutTheBusinessSection = BusinessContactDetails(
    ATBAddress("line1", Some("line2"), Some("some street"), Some("some city"), "GB", Some("EE1 1EE")),
    true,
    Some(
      AlternativeAddress(
        "kap",
        "Trading",
        ATBAddress("Park", Some("lane"), Some("Street"), Some("city"), "GB", Some("EE1 1EE"))
      )
    ),
  ...
  private val premises = OwnBusinessPremisesDetails(
    Some("string"),
    des.tradingpremises.Address("string", Some("string"), Some("string"), Some("string"), "GB", Some("AA1 1AA")),
    false,
  ...
  private val agentPremises = AgentPremises(
    "string",
    des.tradingpremises.Address("string", Some("string"), Some("string"), Some("string"), "GB", Some("AA1 1AA")),
    true,
  ...
  private def agentDetails1 = AgentDetails(
    agentLegalEntity = "Sole Proprietor",
    companyRegNo = None,
    dateOfBirth = Some("1970-01-01"),
    agentLegalEntityName = Some("entity name"),
  ...
  private val nameDtls                      = Some(
    NameDetails(
      PersonName(Some("name"), Some("some"), Some("surname")),
      Some(OthrNamesOrAliasesDetails(true, Some(Seq("Doc")))),
      Some(
        PreviousNameDetails(
          true,
  ...
  private val nationalDtls                  = Some(
    NationalityDetails(true, Some(IdDetail(Some(UkResident("nino")), None)), Some("GB"), Some("GB"))
  )
  private val nationalDtlsPhase2            = Some(
    NationalityDetails(true, Some(IdDetail(Some(UkResident("nino")), None, Some("1970-01-01"))), Some("GB"), Some("GB"))
  )
  private val contactDtls                   = Some(ContactCommDetails("test@test.com", "07000001122", None))
  private val currentDesAddress             = Some(
    CurrentAddress(AddressWithChangeDate("ccLine 1", Some("ccLine 2"), None, None, "GB", Some("AA1 1AA")))
  )
  private val additionalDesAddress          = Some(
    AddressUnderThreeYears(RPAddress("Line 1", Some("Line 2"), None, None, "GB", Some("BB1 1BB")))
  )
  private val extraAdditional               = Some(
    AddressUnderThreeYears(
      RPAddress("e Line 1", Some("e Line 2"), Some("e Line 3"), Some("e Line 4"), "GB", Some("CC1 1CC"))
    )
  )
  private val regDtls                       = Some(RegDetails(false, None, true, Some("0123456789")))
  private val positionInBusinessForRelease7 = Some(
    PositionInBusiness(Some(DesSoleProprietor(true, true, Some(false))), None, None)
  )
  private val positionInBusiness            = Some(PositionInBusiness(Some(DesSoleProprietor(true, true)), None, None))
  ...
  val validResponsiblePersons = Some(
    Seq(
      responsiblePersons.copy(
        ...
        dateChangeFlag = None,
        positionInBusiness =
          Some(PositionInBusiness(Some(DesSoleProprietor(true, true, Some(false), None)), None, None)),
        nameDetails = Some(
          NameDetails(
            PersonName(Some("Jack"), None, Some("Humphrey")),
            Some(OthrNamesOrAliasesDetails(false, None)),
            Some(PreviousNameDetails(false, None, None, None))
          )
        ),
        msbOrTcsp = None
      )
  ...
  val ResponsiblePersonsSection1 = Some(
    Seq(
      ResponsiblePersons(
        nameDetails = nameDtls,
        nationalityDetails = nationalDtls,
  ...
  val ResponsiblePersonsSectionPhase2                                             = Some(
    Seq(
      ResponsiblePersons(
        nameDtls,
        nationalDtlsPhase2,
  ...
  val ResponsiblePersonsSectionForRelease7                                        = Some(
    Seq(
      ResponsiblePersons(
        nameDetails = nameDtls,
        nationalityDetails = nationalDtls,
  ...
  val ResponsiblePersonsSectionForRelease7Phase2: Option[Seq[ResponsiblePersons]] = Some(
    Seq(
      ResponsiblePersons(
        nameDetails = nameDtls,
  ...
  val ResponsiblePersonsSectionForRelease7Phase21 =
    ResponsiblePersonsSectionForRelease7Phase2.map(x => Seq(x.head.copy(nameDetails = nameDtls1)))
  ...
  private val supervisionDetails      = SupervisionDetails(
    true,
    Some(SupervisorDetails("Company A", "1993-08-25", "1999-08-25", Some(false), "Ending reason"))
  )
  private val supervisionDetails1     =
    SupervisionDetails(true, Some(SupervisorDetails("Company A", "1993-08-25", "1999-08-25", None, "Ending reason")))
  private val professionalBodyDetails = ProfessionalBodyDetails(
    true,
    Some("details"),
    Some(
  ...
  val AspOrTcspSection  = Some(AspOrTcsp(Some(supervisionDetails), Some(professionalBodyDetails)))
  val AspOrTcspSection1 = Some(AspOrTcsp(Some(supervisionDetails1), Some(professionalBodyDetails)))
