...
class BusinessContactDetailsSpec extends PlaySpec {
  ...
  "BusinessContactDetails" must {
    ...
    "seralize model with uk registered office and uk alternate address " in {
      ...
      val json = Json.obj(
        ...
        "alternativeAddress"       -> Json.obj(
          "name"        -> "Some Name",
          "tradingName" -> "Some business",
          "address"     -> Json
            .obj("addressLine1" -> "alt 1", "addressLine2" -> "alt 2", "country" -> "GB", "postcode" -> "BB1 1BB")
        ),
  ...
  "seralize model with uk registered office and non uk alternate address" in {
    val desBusinesContact = BusinessContactDetails(
      ...
      true,
      Some(AlternativeAddress("Some Name", "Some business", Address("alt 1", Some("alt 2"), None, None, "GB", None))),
      "07000111222",
      "test@gmail.com"
    )
    ...
    val json = Json.obj(
      "businessAddress"          -> Json
        .obj("addressLine1" -> "number", "addressLine2" -> "some street", "country" -> "GB", "postcode" -> "AA1 1AA"),
      "altCorrespondenceAddress" -> true,
      "alternativeAddress"       -> Json.obj(
        "name"        -> "Some Name",
        "tradingName" -> "Some business",
        "address"     -> Json.obj("addressLine1" -> "alt 1", "addressLine2" -> "alt 2", "country" -> "GB")
      ),
      "businessTelNo"            -> "07000111222",
      "businessEmail"            -> "test@gmail.com"
    )
  ...
  "seralize model with non uk registered office and non uk alternate address" in {
    ...
    val json = Json.obj(
      "businessAddress"          -> Json.obj("addressLine1" -> "doornumber", "addressLine2" -> "some street", "country" -> "GB"),
      "altCorrespondenceAddress" -> true,
      "alternativeAddress"       -> Json.obj(
        "name"        -> "Some Name",
        "tradingName" -> "Some business",
  ...
  "convert BusinessContactDetails correctly with registered office non UK and alternate Address non UK" in {
    ...
    val desBusinesContact = des.aboutthebusiness.BusinessContactDetails(
      ...
      true,
      Some(AlternativeAddress("Some Name", "Some business", Address("alt 1", Some("alt 2"), None, None, "AR", None))),
      "07000111222",
      "test@gmail.com"
    )
