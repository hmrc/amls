...
/*
    ...
    ResponsiblePersons(Some(NameDetails(PersonName(Some(name),Some(some),Some(surname)),Some(OthrNamesOrAliasesDetails(true,Some(List(Doc)))),Some(PreviousNameDetails(true,Some(PersonName(Some(fname),Some(mname),Some(lname))),Some(1990-02-24),false)))),Some(NationalityDetails(true,Some(IdDetail(Some(UkResident(nino)),None,Some(1990-02-24))),Some(GB),Some(GB))),Some(ContactCommDetails(test@test.com,07000001122,None)),Some(CurrentAddress(AddressWithChangeDate(ccLine 1,ccLine 2,None,None,GB,Some(AA1 1AA),None))),Some(0-6 months),Some(AddressUnderThreeYears(Address(Line 1,Line 2,None,None,GB,Some(BB1 1BB)))),Some(7-12 months),Some(AddressUnderThreeYears(Address(e Line 1,e Line 2,Some(e Line 3),Some(e Line 4),GB,Some(CC1 1CC)))),Some(1-3 years),Some(PositionInBusiness(Some(SoleProprietor(true,true,Some(false),None)),None,None)),Some(RegDetails(false,None,true,Some(0123456789))),true,Some(Some training),true,Some(test),None,false,None,Some(false),Some(false),RPExtra(None,None,None,None,None,None,None,None,None)) was not equal to ResponsiblePersons(Some(NameDetails(PersonName(Some(name),Some(some),Some(surname)),Some(OthrNamesOrAliasesDetails(true,Some(List(Doc)))),Some(PreviousNameDetails(true,Some(PersonName(Some(fname),Some(mname),Some(lname))),Some(1990-02-24),true)))),Some(NationalityDetails(true,Some(IdDetail(Some(UkResident(nino)),None,Some(1990-02-24))),Some(GB),Some(GB))),Some(ContactCommDetails(test@test.com,07000001122,None)),Some(CurrentAddress(AddressWithChangeDate(ccLine 1,ccLine 2,None,None,GB,Some(AA1 1AA),None))),Some(0-6 months),Some(AddressUnderThreeYears(Address(Line 1,Line 2,None,None,GB,Some(BB1 1BB)))),Some(7-12 months),Some(AddressUnderThreeYears(Address(e Line 1,e Line 2,Some(e Line 3),Some(e Line 4),GB,Some(CC1 1CC)))),Some(1-3 years),Some(PositionInBusiness(Some(SoleProprietor(true,true,Some(false),None)),None,None)),Some(RegDetails(false,None,true,Some(0123456789))),true,Some(Some training),true,Some(test),None,false,None,Some(false),Some(true),RPExtra(None,None,None,None,None,None,None,None,None)) (ResponsiblePersonsSpec.scala:53)
*/
